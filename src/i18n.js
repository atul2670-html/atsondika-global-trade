...
export const translations = {
  en: {
    ...
    hero_title_2: "Agro Commodities, Dairy Products, Textile Products, Readymade Garments, Used Machinery, New Machinery, Industrial Goods & Fasteners",
    ...
    footer_legal: "© 2026 Atsondika Global Trade. All rights reserved. Registered Export House of India."
  },
  gu: {
    ...
    hero_title_1: "શ્રેષ્ઠ ગુણવત્તાવાળા",
    hero_title_2: "એગ્રો કોમોડિટીઝ પ્રોડક્ટ્સ (કૃષિ ઉત્પાદનો), ડેરી પ્રોડક્ટ્સ (ડેરી ઉત્પાદનો), ટેક્સટાઇલ પ્રોડક્ટ્સ (કાપડ ઉત્પાદનો), રેડીમેડ ગારમેન્ટ્સ પ્રોડક્ટ્સ (તૈયાર વસ્ત્ર ઉત્પાદનો), નવી અને વપરાયેલ મશીનરી, ઔદ્યોગિક માલસામાન પ્રોડક્ટ્સ અને ફાસ્ટનર્સ",
    hero_title_3: "ને વિશ્વ સાથે જોડતી અગ્રણી કંપની",
    hero_subtitle: "મસાલા, ચોખા, તેલીબિયાં, ફાસ્ટનર્સ, નવી અને વપરાયેલી મશીનરી, અને ઇકો પેકેજિંગમાં વિશિષ્ટતા ધરાવતો ૪૦+ દેશોમાં વિશ્વસનીય ભારતીય નિકાસકાર.",
    ...
    footer_legal: "© ૨૦૨૬ Atsondika Global Trade. સર્વાધિકાર સુરક્ષિત."
  },
  hi: {
    ...
    hero_title_1: "प्रीमियम गुणवत्ता वाले",
    hero_title_2: "कृषि उत्पादों (एग्रो कमोडिटीज), डेयरी उत्पादों (डेयरी प्रोडक्ट्स), कपड़ा उत्पादों (टेक्सटाइल प्रोडक्ट्स), रेडीमेड गारमेंट्स उत्पादों (तैयार वस्त्र), नई और पुरानी मशीनरी, औद्योगिक सामान उत्पादों और फास्टनरों",
    hero_title_3: "को दुनिया से जोड़ना",
    ...
    footer_legal: "© 2026 Atsondika Global Trade. सर्वाधिकार सुरक्षित."
  },
  fr: {
    ...
    footer_legal: "© 2026 Atsondika Global Trade. Tous droits réservés."
  }
};

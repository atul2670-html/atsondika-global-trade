...
export const translations = {
  ...
  gu: {
    ...
    tab_used: "જૂની અને વપરાયેલી મશીનરી",
    tab_new: "નવી મશીનરી",
  ...
  hi: {
    ...
    hero_subtitle: "मसालों, चावल, तिलहन, फास्टनरों, नई और पुरानी मशीनरी, और इको पैकेजिंग में विशेषज्ञता वाला 40+ से अधिक देशों में विश्वसनीय भारतीय निर्यातक।",
  ...
  th: {
    tagline_top: "ผู้ส่งออกสินค้าอินเดียที่ได้รับการรับรอง APEDA และ ISO | เมืองสุรัต รัฐคุชราต",
    nav_home: "หน้าแรก",
    nav_about: "เกี่ยวกับเรา",
    nav_products: "แคตตาล็อกสินค้า",
    nav_calc: "เครื่องคำนวณ",
    nav_quality: "ใบรับรองคุณภาพ",
    nav_branches: "สำนักงานทั่วโลก",
    nav_contact: "ติดต่อเรา",
    nav_quote: "ขอใบเสนอราคา",

    hero_badge: "ผู้ส่งออกที่ลงทะเบียน APEDA & ISO 9001:2015",
    hero_title: "เชื่อมโยงสินค้าเกษตรและอุตสาหกรรมคุณภาพพรีเมียมสู่ตลาดโลก",
    hero_subtitle: "ผู้ส่งออกสินค้าอินเดียที่ได้รับความไว้วางใจ เชี่ยวชาญด้านเครื่องเทศ ข้าว เมล็ดพืชน้ำมัน น็อตสกรู เครื่องจักรใหม่และมือสอง รวมถึงบรรจุภัณฑ์รักษ์โลก ส่งออกกว่า 40 ประเทศทั่วโลก",
    hero_btn_products: "สำรวจสินค้า",
    hero_btn_quote: "ขอใบเสนอราคา",
    btn_explore: "สำรวจสินค้า",
    btn_global_trade: "การค้าโลก",
    btn_local_trade: "การค้าในประเทศ",
    btn_rfq: "ขอใบเสนอราคา (RFQ)",

    about_badge: "ผู้ส่งออกชั้นนำจากเมืองสุรัต ประเทศอินเดีย",
    about_title: "ส่งมอบความเป็นเลิศจากอินเดียสู่ตลาดโลก",
    about_desc: "เราเป็นผู้ส่งออกและบริษัทการค้าชั้นนำที่มีสำนักงานใหญ่ในเมืองสุรัต รัฐคุชราต มุ่งมั่นในความบริสุทธิ์ มาตรฐานคุณภาพที่เข้มงวด และการขนส่งที่ราบรื่น",
    
    products_title: "กลุ่มสินค้าส่งออกของเรา",
    products_subtitle: "การตรวจสอบคุณภาพอย่างเข้มงวด มาตรฐานบรรจุภัณฑ์สากล และการจัดส่งตรงเวลา",
    tab_all: "สินค้าทั้งหมด",
    tab_agro: "สินค้าเกษตร",
    tab_used: "เครื่องจักรมือสอง",
    tab_new: "เครื่องจักรใหม่",
    tab_ind: "สินค้าอุตสาหกรรม & ฮาร์ดแวร์",
    tab_eco: "บรรจุภัณฑ์รักษ์โลก",
    tab_apparel: "เครื่องแต่งกาย & สิ่งทอ",

    cert_title: "การรับรองและใบประกาศนียบัตร",
    cert_subtitle: "เอกสารรับรองการส่งออก การจดทะเบียนอย่างเป็นทางการจากภาครัฐ และมาตรฐานคุณภาพ",
    global_title: "จุดหมายปลายทางการส่งออกทั่วโลก",
    global_subtitle: "จัดส่งสินค้าพรีเมียมไปยังศูนย์กลางการค้าสำคัญระหว่างประเทศ",
    contact_title: "ติดต่อเรา",
    contact_subtitle: "มีข้อสงสัยเกี่ยวกับสเปกสินค้า ราคาตู้คอนเทนเนอร์ หรือกำหนดการจัดส่ง?",
    footer_copy: "© Atsondika Global Trade. สงวนลิขสิทธิ์ ผู้ส่งออกได้รับการรับรอง APEDA & ISO 9001:2015"
  },
  ar: {
    tagline_top: "مصدر عالمي ممتاز معتمد من APEDA و ISO | سورات، جوجارات",
    nav_home: "الرئيسية",
    nav_about: "من نحن",
    nav_products: "كتالوج المنتجات",
    nav_calc: "الحاسبة",
    nav_quality: "الشهادات",
    nav_branches: "المكاتب العالمية",
    nav_contact: "اتصل بنا",
    nav_quote: "طلب عرض سعر",

    hero_badge: "مصدر مسجل معتمد APEDA و ISO 9001:2015",
    hero_title: "ربط المنتجات الزراعية والصناعية عالية الجودة بالالعالم",
    hero_subtitle: "مصدر هندي موثوق متخصص في التوابل والأرز والبذور الزيتية وأدوات التثبيت والمعدات الجديدة والمستعملة والتغليف البيئي في أكثر من 40 دولة.",
    hero_btn_products: "استكشف المنتجات",
    hero_btn_quote: "طلب عرض سعر",
    btn_explore: "استكشف المنتجات",
    btn_global_trade: "التجارة العالمية",
    btn_local_trade: "التجارة المحلية",
    btn_rfq: "طلب عرض سعر (RFQ)",

    about_badge: "أبرز المصدرين من سورات، الهند",
    about_title: "تقديم التميز من الأرض الهندية إلى الأسواق العالمية",
    about_desc: "نحن دار تصدير وتجارة رائدة مقرها في سورات، جوجارات. نلتزم بالنقاء التام والبروتوكولات الصارمة واللوجستيات السلسة.",
    
    products_title: "محفظة منتجات التصدير لدينا",
    products_subtitle: "فحص دقيق للجودة ومعايير تعبئة دولية وشحن في الوقت المحدد",
    tab_all: "جميع المنتجات",
    tab_agro: "المنتجات الزراعية",
    tab_used: "معدات مستعملة",
    tab_new: "معدات جديدة",
    tab_ind: "المعدات الصناعية والتثبيت",
    tab_eco: "تغليف بيئي",
    tab_apparel: "الملابس والمنسوجات",

    cert_title: "الاعتمادات والشهادات",
    cert_subtitle: "وثائق تصدير معتمدة والتزامات حكومية رسمية",
    global_title: "وجهات التصدير العالمية",
    global_subtitle: "توريد منتجات ممتازة للمراكز التجارية الدولية الرئيسية",
    contact_title: "اتصل بنا",
    contact_subtitle: "هل لديك استفسارات حول مواصفات التصدير وأسعار الحاويات؟",
    footer_copy: "© Atsondika Global Trade. جميع الحقوق محفوظة."
  },
  es: {
    tagline_top: "Exportador Global de Calidad Superior Certificado por APEDA e ISO | Surat, Gujarat",
    nav_home: "Inicio",
    nav_about: "Nosotros",
    nav_products: "Productos",
    nav_calc: "Calculadoras",
    nav_quality: "Certificaciones",
    nav_branches: "Oficinas Globales",
    nav_contact: "Contacto",
    nav_quote: "Solicitar Cotización",

    hero_badge: "EXPORTADOR REGISTRADO APEDA e ISO 9001:2015",
    hero_title: "Conectando Productos Agrícolas e Industriales de Primera Calidad con el Mundo",
    hero_subtitle: "Exportador indio de confianza especializado en especias, arroz, semillas oleaginosas, fijaciones, maquinaria nueva y usada, y embalajes ecológicos en más de 40 países.",
    hero_btn_products: "Explorar Productos",
    hero_btn_quote: "Solicitar Cotización",
    btn_explore: "Explorar Productos",
    btn_global_trade: "Comercio Global",
    btn_local_trade: "Comercio Local",
    btn_rfq: "Solicitar Cotización (RFQ)",

    products_title: "Nuestro Portafolio de Exportación",
    products_subtitle: "Inspección de calidad rigurosa, estándares de embalaje internacional y envío a tiempo",
    tab_all: "Todos los Productos",
    tab_agro: "Productos Agrícolas",
    tab_used: "Maquinaria Usada",
    tab_new: "Maquinaria Nueva",
    tab_ind: "Industrial y Fijaciones",
    tab_eco: "Embalaje Ecológico",
    tab_apparel: "Ropa y Textiles",
    footer_copy: "© Atsondika Global Trade. Todos los derechos reservados."
  },
  de: {
    tagline_top: "APEDA & ISO-zertifizierter Premium-Globalexporteur | Surat, Gujarat",
    nav_home: "Startseite",
    nav_about: "Über Uns",
    nav_products: "Produkte",
    nav_calc: "Rechner",
    nav_quality: "Zertifikate",
    nav_branches: "Globale Büros",
    nav_contact: "Kontakt",
    nav_quote: "Angebot Anfordern",

    hero_badge: "APEDA & ISO 9001:2015 REGISTRIERTER EXPORTEUR",
    hero_title: "Verbindung von erstklassigen Agrar- und Industrie-Produkten mit der Welt",
    hero_subtitle: "Zuverlässiger indischer Exporteur, spezialisiert auf Gewürze, Reis, Ölsaaten, Befestigungselemente, neue und gebrauchte Maschinen sowie ökologische Verpackungen in über 40 Ländern.",
    hero_btn_products: "Produkte Entdecken",
    hero_btn_quote: "Angebot Anfordern",
    btn_explore: "Produkte Entdecken",
    btn_global_trade: "Welthandel",
    btn_local_trade: "Inlandshandel",
    btn_rfq: "Angebot Anfordern (RFQ)",

    products_title: "Unser Export-Portfolio",
    products_subtitle: "Strenge Qualitätsprüfung, internationale Verpackungsstandards und pünktliche Lieferung",
    tab_all: "Alle Produkte",
    tab_agro: "Agrarprodukte",
    tab_used: "Gebrauchtmaschinen",
    tab_new: "Neumaschinen",
    tab_ind: "Industrie & Befestigungen",
    tab_eco: "Öko-Verpackungen",
    tab_apparel: "Bekleidung & Textilien",
    footer_copy: "© Atsondika Global Trade. Alle Rechte vorbehalten."
  },
  ru: {
    tagline_top: "Премиальный мировой экспортер, сертифицированный APEDA и ISO | Сурат, Гуджарат",
    nav_home: "Главная",
    nav_about: "О нас",
    nav_products: "Каталог товаров",
    nav_calc: "Калькуляторы",
    nav_quality: "Сертификаты",
    nav_branches: "Офисы по миру",
    nav_contact: "Контакты",
    nav_quote: "Запросить цену",

    hero_badge: "ЗАРЕГИСТРИРОВАННЫЙ ЭКСПОРТЕР APEDA И ISO 9001:2015",
    hero_title: "Поставляем высококачественную сельскохозяйственную и промышленную продукцию по всему миру",
    hero_subtitle: "Надежный индийский экспортер, специализирующийся на специях, рисе, масличных культурах, крепеже, новом и б/у оборудовании и эко-упаковке более чем в 40 странах.",
    hero_btn_products: "Смотреть товары",
    hero_btn_quote: "Запросить КП",
    btn_explore: "Смотреть товары",
    btn_global_trade: "Международная торговля",
    btn_local_trade: "Внутренняя торговля",
    btn_rfq: "Запросить КП (RFQ)",

    products_title: "Наш экспортный портфель",
    products_subtitle: "Строгий контроль качества, международные стандарты упаковки и своевременная отгрузка",
    tab_all: "Все товары",
    tab_agro: "Сельхозпродукция",
    tab_used: "Б/У оборудование",
    tab_new: "Новое оборудование",
    tab_ind: "Промышленность и крепеж",
    tab_eco: "Эко-упаковка",
    tab_apparel: "Текстиль и одежда",
    footer_copy: "© Atsondika Global Trade. Все права защищены."
  },
  zh: {
    tagline_top: "APEDA & ISO 认证的优质全球出口商 | 印度古吉拉特邦苏拉特",
    nav_home: "首页",
    nav_about: "关于我们",
    nav_products: "产品目录",
    nav_calc: "计算器",
    ...
    hero_badge: "APEDA & ISO 9001:2015 注册出口商",
    hero_title: "将优质农产品与工业品连接至全球市场",
    hero_subtitle: "值得信赖的印度出口商，专注于香料、大米、油籽、紧固件、新旧机械以及环保包装，业务遍及 40 多个国家。",
    hero_btn_products: "浏览所有商品",
    hero_btn_quote: "获取报价",
    btn_explore: "浏览所有商品",
    btn_global_trade: "全球贸易",
    btn_local_trade: "本地贸易",
    btn_rfq: "询价 (RFQ)",

    products_title: "我们的出口产品组合",
    products_subtitle: "严格的质量检验、国际包装标准和准时发货",
    tab_all: "所有商品",
    tab_agro: "农产品",
    tab_used: "二手机械",
    tab_new: "全新机械",
    ...
    tab_eco: "环保包装",
    tab_apparel: "服装与纺织品",
    footer_copy: "© Atsondika Global Trade. 保留所有权利。"
  }
};

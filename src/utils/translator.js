...
export const MASTER_TRADE_GRAMMAR_DICTIONARY = [
  ...
  // Garments & Textiles
  { en: /Readymade Garments|Ready-made Garments/gi, gu: 'રેડીમેડ ગારમેન્ટ્સ', hi: 'रेडीमेड गारमेंट्स', fr: 'Vêtements Confectionnés', de: 'Konfektionskleidung', es: 'Ropa Confeccionada', ru: 'Готовая одежда', ar: 'ملابس جاهزة', zh: '成衣女装男装', ja: '既製服・アパレル', th: 'เสื้อผ้าสำเร็จรูป' },
  { en: /Surat Textiles|Textile Products|Textiles/gi, gu: 'સુરત ટેક્સટાઈલ્સ', hi: 'कपड़ा उत्पाद (Textiles)', fr: 'Produits Textiles de Surat', de: 'Textilprodukte', es: 'Productos Textiles', ru: 'Текстильная продукция', ar: 'منتجات النسيج', zh: '纺织品面料', ja: '繊維製品・テキスタイル', th: 'สิ่งทอและผ้าซูรัต' },

...
async function testShreeSystemTecDropdown() {
  console.log('🚀 Testing Company Profile Dropdown for Shree System Tec...');
  ...
  await page.screenshot({ path: 'C:/Users/patel/.gemini/antigravity-ide/brain/98fc078e-070c-49c0-83a4-118a59f1909f/shree_system_tec_dropdown.png' });

  await browser.close();
  console.log('✅ Shree System Tec Test Complete!');
}

testShreeSystemTecDropdown().catch(console.error);
